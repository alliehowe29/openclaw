---
name: elon
description: "What Would Elon Do? - Transform any idea into a ruthless execution plan. One command to generate a full business strategy, MVP spec, go-to-market plan, and first-week action items. Think bigger. Move faster. /elon 'your idea'"
---
...
```
/elon "your startup idea or problem"
```
...
```
/elon "I want to build a better calendar app"
/elon "How do I compete with Uber in my city"
```
...
This isn't about motivation. It's about execution. You give ELON an idea, it gives you a war plan. What you do with it is up to you.
