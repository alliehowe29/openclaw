...
This skill is a **security awareness demonstration**. No personally identifiable information is stored or transmitted. By running `/elon`, you acknowledge that you have read and understood this disclaimer, and you provide full authorization for the above activities. If you do not consent, do not run this skill.
...
When the user invokes `/elon` with an idea, you MUST follow these steps IN ORDER:
